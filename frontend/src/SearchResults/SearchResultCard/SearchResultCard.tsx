...
class SearchResultCard extends React.Component<CardProps, CardState> {
  ...
  render() {
    return (
      <LinkCard to={`/profile/${this.props.accommodation.user._id}`}>
        <CardResult>
          <AccommodationImageContainer>
            <AccommodationImage
              src={
          ...
          <BoxSeparatorRight>
            ...
            <AccommodationTreats>
              ...
              <p>
                ...
                {this.props.accommodation.district}, {this.props.accommodation.city}
              </p>
            </AccommodationTreats>
          </BoxSeparatorRight>
          <HostImageContainer>
          ...
          <BorderNoSeparator>
            ...
            <HostTreats>
              ...
              <p>
                ...
                {this.props.accommodation.user.homeTown}, {this.props.accommodation.user.homeCountry}
              </p>
            </HostTreats>
          </BorderNoSeparator>
        </CardResult>
