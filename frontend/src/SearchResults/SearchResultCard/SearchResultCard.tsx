    ...
    return (
      <CardAccommodation>
        ...
        <BorderBox>
          ...
          <AccommodationDescription>{this.props.descriptionApartment}</AccommodationDescription>
          <AccommodationNumberOfBeds>
            <p>
              ...
              {this.props.numberOfBeds}x available beds
            </p>
            <p>
        ...
        <BorderBox>
          ...
          <UserDescription>{this.props.descriptionHost}</UserDescription>
          <FavoriteFood>
            <p>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 14">
